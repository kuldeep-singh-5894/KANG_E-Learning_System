...
@WebServlet("/Search_g")
public class Search_g extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String like = "%" + search + "%";
		List<Student> list = KangDAO.getGradesByName(like);

		out.print("<table>");
		out.print(
				"<tr><th>Student ID</th><th>Name</th><th>Course</th><th>Assignment 1</th><th>Assignment 2</th><th>Assignment 3</th><th>Assignment 4</th><th>Assignment 5</th><th>Test 1</th><th>Test 2</th><th>Test 3</th></tr>");
		for (Student s : list) {
